<?php
class Manipulasi_Perkembangan_Anak_M extends CI_Model{
    ...
    public function  view_by_kode_perkembangan()
    {
        $sql = "SELECT *
    ...
    public function insert(){
        $sql="insert into tbl_laporanperkembangan
					(kode_perkembangan, id_pengajar, nis, kode_mapel, nilai, keterangan)
					values
					('".$this->get_kode_perkembangan()."','".$this->get_id_pengajar()."','".$this->get_nis()."','".$this->get_kode_mapel()."','".$this->get_nilai()."','".$this->get_keterangan()."')";
        $this->db->query($sql);
    }

    public function update(){
        $sql = "update tbl_laporanperkembangan
					set id_pengajar='".$this->get_id_pengajar()."', nis='".$this->get_nis()."', kode_mapel='".$this->get_kode_mapel()."', nilai='".$this->get_nilai()."', keterangan='".$this->get_keterangan()."'
					where kode_perkembangan='".$this->get_kode_perkembangan()."'";
        $this->db->query($sql);
    }
