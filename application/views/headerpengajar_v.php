        ...
        <div>
            <nav class="collapse navbar-collapse" id="myNavbar" role="navigation">
                <ul class="nav navbar-nav navbar-right navstyle">
                    <li><a href="<?php echo site_url();?>manipulasi_perkembangan_anak" class="page-scroll">Perkembangan Anak</a></li>
                    <li><a href="<?php echo site_url();?>data_konsultasi" class="page-scroll">Konsultasi</a></li>
                    <li><a href="<?php echo site_url();?>manipulasi_mapel" class="page-scroll">Mapel</a></li>
                    <li><a href="<?php echo site_url();?>manipulasi_jadwal" class="page-scroll">Jadwal</a></li>
                    <!--li><a href="<?php echo site_url();?>manipulasi_gantipassword" class="page-scroll">Ganti Password</a></li-->
                </ul>
            </nav>
        </div>
    </div>
