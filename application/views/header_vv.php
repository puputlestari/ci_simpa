        ...
        <div>
            <nav class="collapse navbar-collapse" id="myNavbar" role="navigation">
                <ul class="nav navbar-nav navbar-right navstyle">
                    ...
                    <li><a href="<?php echo site_url(); ?>" class="page-scroll">Beranda</a></li>
                    <li><a href="<?php echo site_url(); ?>" class="page-scroll">Galeri</a></li>
                    <li><a href="<?php echo site_url(); ?>" class="page-scroll">Konsultasi</a></li>
                    <?php
                    if($this->session->userdata('username') == "")
                    {
                    ?>
                    <li><a href="<?php echo site_url(); ?>index.php/login " class="page-scroll">Login</a></li>
                    <?php
                    }
                    else
                    {
                    ...
                    <li><a href="<?php echo site_url(); ?>" class="page-scroll">Kontak Kami</a></li>
                </ul>
            </nav>
        </div>
    </div>
