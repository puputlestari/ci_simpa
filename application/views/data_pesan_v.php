    ...
    <div class="container2">
        ...
        <div class="panel-heading">
            ...
            <div class="pull-right">
                <button class="btn btn-primary btn-sm add" title="Tambah" data-toggle="modal" data-target="#modal_data_pesan">
                    <i class="glyphicon glyphicon-plus"></i> Kirim Pesan
                </button>
        ...
        <?php if ($this->session->userdata('status')==1) {
            ...
            <table class="table table-responsive" id="table">
                ...
                $query = $this->data_pesan_m->view_admin();
                ...
                foreach ($query->result() as $row) :
                    ...
                    <tr>
                        ...
                        <input type="hidden" id="judul_<?PHP echo $row->id_pesan; ?>"
                               value="<?PHP echo $row->judul; ?>">
                        <input type="hidden" id="isi_<?PHP echo $row->id_pesan; ?>" value="<?PHP echo $row->isi; ?>">
                        <input type="hidden" id="penerima_<?PHP echo $row->id_pesan; ?>"
        ...
        <?php
            ...
            <table class="table table-responsive" id="table">
                ...
                $query = $this->data_pesan_m->view_pengguna();
                ...
                foreach($query->result() as $row) :
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning btn-sm edit" title="Lihat" data-toggle="modal" data-target="#modal_data_pesan" id="edit_<?PHP echo $row->id_pesan; ?>">
                                <i class="glyphicon glyphicon-edit"></i> Lihat
                            </button>
                            <button class="btn btn-danger btn-sm delete" title="Hapus" data-toggle="modal" data-target="#modal_konfirmasi" id="delete_<?PHP echo $row->id_pesan; ?>">
                                <i class="glyphicon glyphicon-trash"></i> Hapus
                            </button>
                        </td>
                ...
                <form method="post" id="form_data_pesan">
                    <?php if($this->session->userdata('status')==0) {
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="penerima" id="penerima" value="Admin" >
                        </div>
                    <?php
                        ...
                        <div class="form-group">
                            <label>Ke</label>
                            <input type="text" class="form-control" name="penerima" id="penerima" placeholder="Ke"
                                   required>
